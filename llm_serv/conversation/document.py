...
def main():
    ...
    try:
        ...
        try:
            ...
            print(
                f"{SUCCESS if size_matches else FAILURE} Size matches: {pdf_doc.size} bytes vs {loaded_pdf.size} bytes"
            )
...
""".encode(
    ...
    try:
        ...
        try:
            ...
            print(
                f"{SUCCESS if size_matches else FAILURE} Size matches: {text_doc.size} bytes vs {loaded_doc.size} bytes"
            )
            print(f"{SUCCESS if content_matches else FAILURE} Content matches")
